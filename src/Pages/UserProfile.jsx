    ...
    const fetchUserProfile = async () => {
      try {
        ...
        form.setFieldsValue({
          ...
          affiliateAmount:
            format.formatMoney(userData.data.affiliateAmount) + " VNĐ",
        });
      } catch (error) {
    ...
    <div className="user-profile">
      ...
      {user ? (
        ...
        >
          ...
          <Form.Item label="Tiền hoa hồng" name="affiliateAmount">
            <Input readOnly />
          </Form.Item>
                ...
                <DatePicker
                  ...
                  value={
                    searchFilters.fromDate
                      ? moment(searchFilters.fromDate, "DD/MM/YYYY")
                      : null
                ...
                <DatePicker
                  ...
                  value={
                    searchFilters.toDate
                      ? moment(searchFilters.toDate, "DD/MM/YYYY")
                      : null
                  } // Đặt giá trị mặc định nếu có
                />
              </Form.Item>
