...
const Navbar = () => {
  ...
  return (
    <div className="navbar">
      ...
      <img
        className="nav-drowdown"
        onClick={drowdown_toggle}
        src={nav_drowdown}
        alt=""
      />
      <ul ref={menuRef} className="nav-menu">
        ...
        >
          <Link style={{ textDecoration: "none" }} to="/san-pham">
            Sản phẩm
          </Link>
          {menu === "san-pham" ? <hr /> : <></>}
        </li>
        ...
        >
          <Link style={{ textDecoration: "none" }} to="/gioi-thieu">
            Giới thiệu
          </Link>
          {menu === "gioi-thieu" ? <hr /> : <></>}
        </li>
        ...
        >
          <Link style={{ textDecoration: "none" }} to="/chinh-sach">
            Chính sách
          </Link>
          {menu === "chinh-sach" ? <hr /> : <></>}
        </li>
        ...
        >
          <Link style={{ textDecoration: "none" }} to="/sunny-website">
            Sunny Website
          </Link>
          {menu === "website" ? <hr /> : <></>}
        </li>
        ...
        {isLoggedIn ? (
          <>
            ...
            <button
              ...
              onClick={() => {
                setMenu("logout"); // Cập nhật trạng thái menu
